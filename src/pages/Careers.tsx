    ...
    <main>
      ...
      <section className="bg-gradient-stats relative overflow-hidden py-24">
        ...
        <div className="container mx-auto relative z-10 text-center">
          <p className="text-brand-orange font-bold uppercase tracking-widest text-sm mb-3">Join Our Team</p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-white border border-border rounded-lg p-6 text-center service-card shadow-card">
                <div className="w-16 h-16 rounded-xl bg-brand-blue/10 flex items-center justify-center text-brand-blue mx-auto mb-4">
                  {item.icon}
                </div>
      ...
      <section className="py-20">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {openings.map((job, i) => (
              <div key={i} className="service-card bg-white border border-border rounded-lg p-6 md:p-8 flex flex-col md:flex-row items-start md:items-center gap-6">
                <div className="flex-1">
                  <div className="flex flex-wrap items-center gap-3 mb-2">
                    <h3 className="font-display text-xl uppercase text-foreground">{job.title}</h3>
                    <span className={`text-xs font-bold uppercase tracking-widest px-3 py-1 rounded-full ${job.type === "Internship" ? "bg-brand-orange/10 text-brand-orange" : "bg-brand-blue/10 text-brand-blue"}`}>
                      {job.type}
                    </span>
                  </div>
                ...
                <a
                  ...
                  className="flex-shrink-0 bg-brand-blue text-white font-bold uppercase tracking-widest text-sm px-6 py-3 rounded flex items-center gap-2 hover:bg-brand-orange transition-colors"
                >
          ...
          <div className="mt-12 text-center">
            <div className="bg-muted/50 border border-border rounded-xl p-8 max-w-2xl mx-auto">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 bg-brand-orange text-white font-bold uppercase tracking-widest text-sm px-8 py-4 rounded hover:bg-brand-blue transition-colors"
              >
